...
class AuthUser(Tk):
    def __init__(self):
        ...
        companyLabel = Label(displayFrame, text='Regmi Electricals Centre',
                             fg='#000000',bg = '#ffffff', font=('Helvetica',int(WR*25),'bold', 'underline'))
        ...
        self.password_entry = Entry(passwordFrame,border = 0,width = int(WR*15),font=('default',int(WR*12),), bg = '#f0f3f7')
        ...
        loginbutton = Button(detailsframe,text='Get Access', border = 0,width = int(WR*15),bg='#151FC4',fg = '#ffffff',font=('Helvetica',int(WR*13),'bold'), command = self.checkPass)
        ...
        forgotPassword = Button(detailsframe, text='Forgot Password ?', cursor="hand2", border=0,
                                bg='#ffffff', fg='red', font=('Helvetica', int(WR*10), 'underline'), command=self.saendPassword)
